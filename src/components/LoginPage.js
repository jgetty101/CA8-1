      ...
      <div id="loginPage" className="mode-page">
        ...
        >
          <div className="toast-text">
            New account created with email{" "}
            <span id="accountCreatedEmail"></span>
          </div>
          <button
        ...
        <p id="errorBox" className="alert alert-danger centered hidden">
          <a id="emailError" href="#email" className="alert-link">
            Enter a valid email address
            <br />
          </a>
          <a id="passwordError" href="#password" className="alert-link">
            Enter a valid password
          </a>
          <a id="authError" href="#email" className="alert-link">
            No user account exists with email and password entered. Create an
            account or re-enter email and/or password
          </a>
        </p>
